 ...
 * Author             : Andrey Dimnachev
 * Co-Author	      : Aly Masani
 ******************************************************************************
 *
 * Notes: SPI Driver for an ADC
 * Original is available here: 
 * https://github.com/StudentOrganisationForAerospaceResearch/AvionicsSoftware/blob/Andrey/SPI_Driver/Components/Communication/SPIDriver.cpp
 *
 ******************************************************************************
*/
